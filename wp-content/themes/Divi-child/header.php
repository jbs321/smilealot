...
?>
	...
	<?php if ( $et_top_info_defined ) : ?>
		<div id="top-header" class="<?php echo esc_attr( $secondary_nav_class ); ?>">
			...
			<span id="et-info-address">#277 - 5655 Cambie St., Vancouver</span>
			
			<?php if ( $et_contact_info_defined ) : ?>

				<div id="et-info">
				<span class="highlight">Schedule Your Appointment Today!</span> <?php if ( '' !== ( $et_phone_number = et_get_option( 'phone_number' ) ) ) : ?>
...
<?php 
    echo do_shortcode("[metaslider id=254]"); 
?>
